...
DEFINE_TEST(testAddBigInt2, "-", {
    ...
    BigInt* c = addBigInt(a, b);
    ASSERT_BIGINT(c, "18291357824691357802");
    freeBigInt(a);
    freeBigInt(b);
    freeBigInt(c);
})
...
DEFINE_TEST(testAddBigInt6, "-", {
    ...
    BigInt* c = addBigInt(a, b);
    ASSERT_BIGINT(c, "14966048989831189770931389386893450031259204");
    freeBigInt(a);
    freeBigInt(b);
    freeBigInt(c);
})
...
DEFINE_TEST(testAddBigInt7, "-", {
    ...
    BigInt* b = createBigIntFromString(str("abcdefabcdefabcdefabcdefabcdefab"), 16);
    BigInt* c = addBigInt(a, b);
    ASSERT_BIGINT(c, "14966505724369675501907842622245151975259546");
    freeBigInt(a);
    freeBigInt(b);
    freeBigInt(c);
})
...
DEFINE_TEST(testMulBigInt4, "-", {
    ...
    BigInt* c = mulBigInt(a, b);
    ASSERT_BIGINT(c, "121932631356500531347203169112635269");
    freeBigInt(a);
    freeBigInt(b);
    freeBigInt(c);
})
...
DEFINE_TEST(testMulBigInt5, "-", {
    ...
    BigInt* b = createBigIntFromString(str("abcdefabcdefabcdefabcdefabcdefab"), 16);
    BigInt* c = mulBigInt(a, b);
    ASSERT_BIGINT(c, "3417807890772355817164787473054487168320873578264084521151908534580112334057353125");
    freeBigInt(a);
    freeBigInt(b);
    freeBigInt(c);
})
...
DEFINE_TEST(testShiftLeftBigInt3, "-", {
    ...
    ASSERT_BIGINT(c, "");
    freeBigInt(a);
    freeBigInt(c);
})
...
DEFINE_TEST(testShiftLeftBigInt4, "-", {
    ...
    ASSERT_BIGINT(c, "-446620606583731733295679172254195777536");
    freeBigInt(a);
    freeBigInt(c);
})
