...
args_defs : %empty                  { $$.list = createAstList(@$, AST_LIST, 0, NULL); $$.flags = AST_FN_FLAG_NONE; }
          | args_def_list           { $$.list = toStaticAstList($1); $$.flags = AST_FN_FLAG_NONE; }
          | args_def_list ','       { $$.list = toStaticAstList($1); $$.flags = AST_FN_FLAG_NONE; }
          | args_def_list ',' ".."  { $$.list = toStaticAstList($1); $$.flags = AST_FN_FLAG_VARARG; }
          ;
